...
event_name_list = ["🔥 Код Будущего - подготовительный этап",
                   "Бесплатный курс «Промпт-master»",
                   "Бесплатный курс «Создание сайтов»",
                   "Бесплатный курс «Старт в профессии»",
                   "Конференция «Основы маркетинга»"]
...
def events_keyboard():
    ...
    inline.row(InlineKeyboardButton(text=event_name_list[4], callback_data="e_5"))
