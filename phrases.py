...
PERS_DATA_REQUEST = """Привет! 👋 Добро пожаловать в "ИТ-горизонты"! Мы рады, что вы участвуете в нашем опросе. Ваше мнение поможет сделать обучение ИТ-навыкам еще более интересным и полезным. Давайте начнем!
